...
## 开发中不打断（2026-09-21 用户口径）

**日报/周报的素材采集不在开发过程中进行，也不阻塞开发。**

- 需要的素材（执行差异、协同人、卡点期望时间、上线验证结论…）**先记不先问**：随手落进当日素材卡，标"待确认"。
- 所有要人回答的问题**攒到收工/成稿时一次性问**（可多条多天一起答）。
- **唯一例外**：继续做会返工或做错方向的问题——当场问，但必须**给出默认做法**，只让对方回"行/不行"。
